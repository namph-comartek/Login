    ...
    <div className="form-content-right">
      <form onSubmit={handleSubmit} className="form" noValidate>
        ...
        <div className="form-inputs">
          ...
          <input className="form-input" type="email" name="email" placeholder="Enter your email" value={values.email} onChange={handleChange} />
        ...
        <div className="form-inputs">
          ...
          <input className="form-input" type="password" name="password2" placeholder="Confirm your password" value={values.password2} onChange={handleChange} />
        ...
        <span className="form-input-login">
          Already have an account? Login <a href="../login/FromLogin">here</a>
        </span>
      </form>
    </div>
  );
